...
\[
w_E
=w_0\left(1+g(L_{\mathrm{eff}})\right)^{\rho}
\]
...
\[
E^{scaled}_i
=10\cdot \operatorname{Normalize}(E^{comp}_i+E^{trans}_i;0,20)
\]
...
=
\begin{cases}
-C_i^{adapt}, & \text{if task } i \text{ is unfinished},\\
